...
export default function SupportClient() {
  ...
  React.useEffect(() => {
    ...
    const timer = setTimeout(() => {
      ...
      ]).then(([usersRes, eventsRes, integrationsRes]) => {
  ...
  const hasAnyErrors = users.error || events.error || integrations.error;
      ...
      <div className="mx-auto max-w-6xl">
        ...
        <div className="mb-8">
          ...
          <p className="mt-2 text-sm text-ink-muted max-w-2xl">
            Unified search across Users, Events, and Integrations. Enter an email, name, event code, or third-party ID to begin diagnosing.
          </p>
        </div>
        ...
        <div className="mb-8 rounded-xl bg-surface-card p-4 shadow-sm border border-border flex flex-col md:flex-row gap-4 items-center relative z-10">
          <div className="relative flex-1 w-full">
            ...
            <input
              type="text"
              autoFocus
              placeholder="Search by email, event code, zoom ID..."
              value={query}
        ...
        {!loading && isValidQuery && !hasResults && !hasAnyErrors && (
          <div className="rounded-xl border border-dashed border-border py-20 text-center bg-surface-canvas/50">
            ...
            <p className="mt-1 text-xs text-ink-muted">
              We could not find any users, events, or integrations matching &quot;{query}&quot;.
            </p>
          </div>
        )}
