...
import { Briefcase, Star, BarChart3, Heart } from 'lucide-react';

export const EVENTS_TEMPLATES: EventTemplate[] = [
  {
    id: 'events-1',
    name: 'Events Template 1',
    description: 'A ready-to-use template for Events activities.',
    icon: Briefcase,
    estimatedDuration: '60 mins',
    recommendedAudience: 'Any size',
    difficulty: 'Standard',
    tags: ['events', 'interactive', 'engagement'],
    categories: ['Events'],
    settings: {
