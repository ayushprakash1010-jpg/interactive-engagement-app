...
import { RefreshCw, Coffee, Star, MessageCircleQuestion } from 'lucide-react';

export const COMMUNITY_TEMPLATES: EventTemplate[] = [
  {
    id: 'community-1',
    name: 'Community Template 1',
    description: 'A ready-to-use template for Community activities.',
    icon: Star,
    estimatedDuration: '30 mins',
    recommendedAudience: 'Any size',
    difficulty: 'Quick',
    tags: ['community', 'interactive', 'engagement'],
