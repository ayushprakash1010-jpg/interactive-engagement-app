...
export const SALES_TEMPLATES: EventTemplate[] = [
  {
    id: 'sales-1',
    name: 'Sales Template 1',
    description: 'A ready-to-use template for Sales activities.',
    icon: GraduationCap,
    estimatedDuration: '5 mins',
    recommendedAudience: 'All hands',
    difficulty: 'Quick',
    tags: ['sales', 'interactive', 'engagement'],
    categories: ['Sales'],
    settings: {
