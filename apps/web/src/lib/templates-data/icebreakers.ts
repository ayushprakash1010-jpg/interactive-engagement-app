...
import { Mic, RefreshCw, Heart, Check, MessageCircleQuestion } from 'lucide-react';

export const ICEBREAKERS_TEMPLATES: EventTemplate[] = [
  {
    id: 'icebreakers-1',
    name: 'Icebreakers Template 1',
    description: 'A ready-to-use template for Icebreakers activities.',
    icon: Mic,
    estimatedDuration: '10 mins',
    recommendedAudience: 'Any size',
    difficulty: 'Standard',
    tags: ['icebreakers', 'interactive', 'engagement'],
