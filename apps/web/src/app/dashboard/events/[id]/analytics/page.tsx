...
import { AIInsightsDashboard } from "@/components/ai-studio/intelligence";
const CHART_COLORS = [
  "var(--data-1)",
  "var(--data-2)",
  "var(--data-3)",
    ...
    <div className="space-y-8">
      ...
      <Tabs defaultValue="intelligence" className="space-y-6">
        ...
        <TabsContent value="intelligence" className="mt-0 outline-none">
          <AIInsightsDashboard eventId={id} />
        </TabsContent>

        <TabsContent value="quantitative" className="mt-0 space-y-8 outline-none">
